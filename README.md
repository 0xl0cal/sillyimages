...
- **Лорбуки** — именованные коллекции дополнительных референсов. Доступны создание / переименование / удаление / enable-toggle через кнопки рядом с dropdown'ом. Matcher собирает refs изо всех enabled лорбуков.
