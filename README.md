...
- Опция **Send character descriptions** добавляет включённые описания текущего персонажа и персоны в prompt. Изображения отправляются только моделям с поддержкой референсов.
