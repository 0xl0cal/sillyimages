...
- **Отправлять аватар {{user}}** — выбирается вручную из списка `/User Avatars/`
  - При включении появляется dropdown с выбором аватара
  - Кнопка обновления загружает список доступных аватаров
...
5. Заменяет тег на сгенерированную картинку
6. Сохраняет картинку в файл и обновляет сообщение
